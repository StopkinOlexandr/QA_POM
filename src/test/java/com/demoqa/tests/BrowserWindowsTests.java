...
public class BrowserWindowsTests extends  TestBase{
  ...
  public void openNewWindowTest() {
    new BrowserWindowsPage(wd).switchToNewWindow(1).assertNewWindowMessage("This is a sample page");
  }

//  @Test
//  public void openNewTabTest() {
//    new BrowserWindowsPage(wd).switchToNewTab().assertNewTabMessage("This is a sample page");
//  }
}
