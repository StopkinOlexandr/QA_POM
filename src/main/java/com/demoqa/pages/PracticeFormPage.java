...
public class PracticeFormPage extends BasePage {
  ...
  public PracticeFormPage enterPersonalData(String fName, String lName, String email,
      String phone) {
...
//    wd.findElement(By.cssSelector("[aria-label='Choose" + dWeek , "+ m + " " + day + ", " + year]"

    return this;
  }

//  public PracticeFormPage switchToNewWindow(int index) {
//    clickWithRectangle(submit, 3, 4);
////    click(windowButton);
...
//  }
  ...
  public PracticeFormPage assertModalWindowMessage(String text) {
    Assert.assertTrue(shouldHaveText(exampleModal, text, 5));
    return this;
  }
}